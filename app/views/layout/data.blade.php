      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li @yield('aktif2')>
              <a href="{{ URL::To('pesananbaru') }}">
                <?php $jumlah_pesanan_baru = Lampu::where('status','=',1)->count('id');?>
                <i class="fa fa-files-o"></i> <span>Pemesanan Baru</span>
                <small class="label pull-right bg-yellow">{{$jumlah_pesanan_baru}}</small>
              </a>
            </li>
            <li @yield('aktif3')>
              <a href="{{ URL::To('manajemen-user') }}">
